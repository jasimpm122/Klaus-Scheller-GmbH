...
import { useMediaQuery } from 'react-responsive'; // For responsive logic
import member1 from '../images/Art.jpg'
import member2 from '../images/Art.jpg'
import member3 from '../images/Art.jpg'

function About() {
    // Check if the screen width is less than or equal to 768px (mobile & tablets)
    const isMobileOrTablet = useMediaQuery({ query: '(max-width: 768px)' });

    return (
        <div style={{ padding: isMobileOrTablet ? '50px 20px' : '200px', textAlign: 'center', color: 'black' }}>
